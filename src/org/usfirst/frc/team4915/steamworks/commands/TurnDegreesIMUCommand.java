...
public class TurnDegreesIMUCommand extends Command
{
    ...
    public TurnDegreesIMUCommand(Drivetrain drivetrain, double degrees)
    {
        ...
        m_logger = new Logger("TurnDegreesIMUCommand", Logger.Level.DEBUG);
        m_degrees = degrees;
    ...
    protected void initialize()
    {
        ...
        m_logger.debug("TurnDegreesIMUCommand I want to turn  " + m_degrees + " degrees.");
        m_logger.info("TurnDegreesIMUCommand initalized");
    }
    ...
    {
        m_drivetrain.endIMUTurn();
        m_logger.debug("TurnDegreesIMUCommand Actual degrees driven " + m_drivetrain.getIMUNormalizedHeading());
        m_logger.debug("TurnDegreesIMUCommand Desired degrees driven " + m_degrees);
        m_logger.debug("TurnDegreesIMUCommand Difference ticks " + ((m_degrees) - m_drivetrain.getIMUNormalizedHeading()) + " ticks.");
        m_logger.info("TurnDegreesIMUCommand ended");
    ...
    protected void interrupted()
    {
        ...
        m_logger.info("TurnDegreesIMUCommand interrupted");
    }
}
