 ...
 * // m_drivetrain.resetEncPosition(); (since this method doesn't take effect
 * immediately, we try an alternate approach)
 * m_startTicks = m_drivetrain.getAvgEncPosition();
